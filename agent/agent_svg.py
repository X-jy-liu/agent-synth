...
from .prompts_svg import LLM_grammar_sys, LLM_program_synthesis_prompt, LLM_EXPRESSION_MODIFIER_PROMPT
from .prompts import VLM_edits_sys, VLM_edits_user_2, VLM_scene_description_prompt
...
class Agent:
    ...
    def _generate_modified_expression(self, current_expression, collected_actions) -> str:
        ...
        response = call_llm(messages, model_name=self.model_name)
        logging.info(response)
        new_program = parse_answer_json(response)
        return new_program
