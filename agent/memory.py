...
class State:
    """
    Represents a single state in the optimization process.
    
    Attributes:
        current_expression: The tinySVG expression as a string
        scene_description: VLM scene description (dict with primitives, bg_color, etc.)
        primitive_actions: Dict mapping primitive_id to list of VLM actions
                          e.g., {"rect_1": ["MOVE_RIGHT", "SCALE_UP_Y"], "ellipse_2": ["FILL_blue"]}
    """
...
class Memory:
    """
    Maintains a collection of states and provides access to historical data.
    """
